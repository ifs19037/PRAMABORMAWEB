                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class="custom-file">
                                        ...
                                        <input type="date" name="tanggal_kuis" id="flatpickrSample01" type="text" class="col-sm-3 col-form-label form-label" data-toggle="flatpickr" placeholder="M D, Y" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="qtitle" class="col-form-label form-label col-md-3">Link Kusioner</label>
                                <div class="col-md-9">
                                    <div class="custom-file">
                                        <input name="link_kusioner" type="text" class="form-control" required>
                                    </div>
                                </div>
                            </div>
